...
private fun StatsScreenContent(
    ...
    LazyColumn(
        ...
        item {
            ...
            StatsHeaderCard(
                isSelected = uiState.activeItemType == ItemType.PLATE && uiState.collection.isEmpty(),
                ...
                fontSize = 18.sp,
                onClick = { viewModel.setActiveItemType(ItemType.PLATE) }
            )
            Row(modifier = Modifier.padding(bottom = 32.dp)) {
                StatsHeaderCard(
                    ...
                    onClick = { viewModel.setActiveItemType(ItemType.WANTED_PLATE) }
                )
                ...
                StatsHeaderCard(
                    ...
                    modifier = Modifier.weight(1f),
                    onClick = { viewModel.setActiveItemType(ItemType.FORMER_PLATE) }
                )
            }
        }
        item {
